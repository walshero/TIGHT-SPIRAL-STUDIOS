...
## 2026-07-27 — Founder log: accessibility lane + "no fabricated studio moves" made canon

**DECIDED — No fabricated studio moves (CANON, verbatim).** *"I revoke your ability to fabricate studio moves."* Never assert a studio deployment, client, live engagement, or business relationship not verified from source or confirmed by Matt. Default to **"designed for"** over "running / live / inside." An unverified studio move is a wish — name it, don't claim it. Folded into `founder-canon.md` (Part II, the truth-floor ruling); inherits the reliability floor.
