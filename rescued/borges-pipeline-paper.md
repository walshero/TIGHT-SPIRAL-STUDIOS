...
## Menard: the copy that isn't

"Pierre Menard, Author of the Quixote" (1939) describes a writer who sets out not to copy Don Quixote but to compose it again, word for word, from inside his own century. The pages he produces are verbally identical to Cervantes. Borges's narrator judges them anyway to be "almost infinitely richer," because the same sentences, written three hundred years later by a different mind, no longer carry the same meaning. Context is not decoration laid over the words. Context is what the words are.

This is the studio's method stated as a story. One engine, built by hand, is pointed at a new domain and then pointed again: a dark-patterns console, a presidential-choice simulator, a cliché cabinet, all running the same machinery on different material. A skeptic calls this repetition. Menard calls it authorship, on one condition. The new domain has to actually change what the mechanic means. The reward schedule that trains a growth-team intern becomes, aimed back at the player, a lesson in having been trained. Same engine, new work. When a reskin cannot say what its domain changed, it is not a Menard. It is the map the size of the territory, faithful and useless, and the pipeline stops it there.
