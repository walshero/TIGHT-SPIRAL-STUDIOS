...
**CANON LIVES IN THE REPO:** `walshero/TIGHT-SPIRAL-STUDIOS`. The founder's own GitHub.
No institution. No size limit. Full history. **Git is the only lane with a mechanism
...
## ✅ CLOSED 2026-07-13 — THE ARCHAEOLOGY IS OVER

**The 29 orphans are rescued.** 21 Drive-only files landed byte-verified (commit `c17865d`)
in `rescued/drive-2026-07-13/`: ten games (dad-energy 72KB, dad-quest, snack-run-zombie-maze,
castle-progress, story-detective, the-late-sign, workshop-in-a-box, litmag-desk, enforcer,
leeder-spoof), en-assessment-hub (95KB), en-faculty-orientation, **all three Writerly Moves
...
**First question of the review — TWO TAXONOMIES that barely overlap:**
