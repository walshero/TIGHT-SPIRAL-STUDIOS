...
**The moat — the founder's central, distinctive value (named 2026-06-30):** the founder designs **assessment and calibration artifacts** — norming, scoring, rater-training, calibration-for-application. The strength is fighting garbage-in-garbage-out at the *design* layer: building the scaffolding that makes human judgment consistent, teachable, and reliable, powered by strong systems thinking. **The games are the delivery vehicle; the calibration engine underneath is the thing nearly no one else in the learning-games field is doing.** This reframes what the studio is: not "an English professor who makes writing games" (the costume) but an **assessment-design practice** wearing a game's clothes (the moat). It is a bigger, better-funded, more durable field than creative-writing-games, and the founder's accessibility floors + transparency vow make this version *trustworthy* in a way the AI-auto-scoring crowd structurally cannot claim. Every build should know which layer it is serving: the calibration spine, or the delivery costume. When they conflict, the spine is the value.

**Strengths to lean on (in service of the moat above):**
- **Assessment/calibration/norming design** — the moat. Rater calibration, anchor design, drift detection, scoring-artifact construction. This is the home field; lean here first.
- **Systems thinking** — the founder sees the whole scaffold and how its parts norm each other. This is what makes the calibration work, and (newly recognized 2026-06-30) it is also why the founder can now *code* the artifacts directly.
